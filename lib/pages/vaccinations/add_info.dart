...
class _AddInfoState extends State<AddInfo> {
  ...
  void _createUserVaccin() {
    ...
    if (isValid == false) {
      ...
      _vaccin.createUserVaccin(_userNameTextController.text, _birthdayTextController.text, _phoneTextController.text, _cccdTextController.text, _typevaccinTextController.text);
    }
  }
